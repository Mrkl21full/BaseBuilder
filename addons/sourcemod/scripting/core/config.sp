void SetupConfig()
{
	...
	g_cRemoveBlockAfterDeath = AutoExecConfig_CreateConVar("bb_remove_block_after_death", "1", "Removes blocks when player dies (or he disconnect).", _, true, 0.0, true, 1.0);
